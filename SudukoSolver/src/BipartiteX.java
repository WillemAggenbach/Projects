...
/**
 * The {@code BipartiteX} class represents a data type for determining whether
 ...
 * <p>
 * This implementation uses breadth-first search and is nonrecursive. The
 * constructor takes time proportional to <em>V</em> + <em>E</em> (in the worst
 * case), where <em>V</em> is the number of vertices and <em>E</em> is the
 * number of edges. Afterwards, the <em>isBipartite</em> and <em>color</em>
 * operations take constant time; the <em>oddCycle</em> operation takes time
 * proportional to the length of the cycle. See {@link Bipartite} for a
